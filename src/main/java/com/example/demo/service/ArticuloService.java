...
public class ArticuloService extends BaseService<Articulo, ArticuloRepository> {
    ...
    //Para no incluir en el cuerpo del postman el id cuando hago el put. Evitando que se cree otro objeto
@Override
    public Articulo update(String id, Articulo articulo) throws Exception {
        try {
